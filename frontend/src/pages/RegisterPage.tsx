...
import { Leaf, User, Mail, Lock, Building, ArrowRight, AlertCircle, Eye, EyeOff } from 'lucide-react';
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-3 pr-10 py-2 text-xs border border-slate-300 rounded-xl focus:ring-2 focus:ring-emerald-600 focus:outline-none"
                    required
                    minLength={8}
                  />
                  <button
